...
#define INITIAL_NUMBER_OF_SUBJECTS 100
#define SUBJECTS_BY_GENERATION 50
...
#define PROFESSION_DEFENSE 1
#define PROFESSION_MAGICIAN 2
#define PROFESSION_ENGINEER 3
#define PROFESSION_PREACHER 4
#define PROFESSION_QUACK 5
